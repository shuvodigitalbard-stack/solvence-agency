...
export default function Services() {
  ...
  const categories = [
    { key: 'all', label: 'All' }, { key: 'web', label: 'Web' },
    { key: 'mobile', label: 'Mobile' }, { key: 'marketing', label: 'Marketing' },
    { key: 'design', label: 'Design' }, { key: 'consulting', label: 'Consulting' }
  ];
    ...
    <>
      <section style={{ padding: '140px 0 60px', textAlign: 'center', background: 'var(--bg-primary)' }}>
        <div className="container">
          ...
          <p style={{ color: '#4a5568', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto 40px' }}>
