...
import { FiArrowRight, FiCheck, FiUsers, FiAward, FiTrendingUp, FiStar, FiGlobe, FiZap } from 'react-icons/fi';
  ...
  return (
    <>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p className="animate-fade-in-up delay-2" style={{
              fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', color: '#4a5568', maxWidth: '600px',
              margin: '0 auto 40px', lineHeight: 1.8, opacity: 0
            }}>
            ...
            <div className="animate-fade-in-up delay-4" style={{
              ...
              {stats.map((s, i) => (
                ...
                >
                  <div style={{ fontSize: '1.5rem', color: '#c9a83c', marginBottom: '8px', display: 'flex', justifyContent: 'center' }}>{s.icon}</div>
                  <div style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 800, fontFamily: 'Red Hat Display', color: '#1a1a2e' }}>{s.value}</div>
      ...
      <section className="section" style={{ background: 'var(--bg-primary)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', alignItems: 'center' }}>
            <div>
              <h2 style={{
                fontSize: 'clamp(2rem, 4vw, 2.8rem)', marginBottom: '24px',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }}>
                {highlights.map((s, i) => (
                  <div key={i} style={{
                    ...
                    padding: '20px', textAlign: 'center', transition: 'var(--transition)'
                  }}
                  onMouseEnter={e => e.currentTarget.style.background = 'rgba(224,192,96,0.15)'}
                  onMouseLeave={e => e.currentTarget.style.background = 'rgba(224,192,96,0.08)'}
                  >
      ...
      <section style={{ padding: '80px 0', background: '#fff' }}>
        <div className="container">
          <div style={{
            background: 'var(--gradient)', borderRadius: '24px', padding: 'clamp(40px, 6vw, 60px) clamp(24px, 4vw, 40px)',
            ...
            <h2 style={{
              fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', marginBottom: '16px',
              position: 'relative', zIndex: 1, color: '#fff', fontFamily: 'Red Hat Display'
            }}>
              Ready to Start Your Project?
            </h2>
            <p style={{
              fontSize: '1.1rem', opacity: 0.9, maxWidth: '500px', margin: '0 auto 32px',
