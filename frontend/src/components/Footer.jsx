...
export default function Footer() {
  ...
  return (
    <footer style={{ background: 'var(--bg-dark)', borderTop: '1px solid rgba(255,255,255,0.05)', padding: '60px 0 30px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '32px', marginBottom: '40px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <Link to="/admin/login" style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Admin</Link>
            </div>
          </div>
